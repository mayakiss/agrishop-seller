...
class MyTheme {
  static const Color app_accent_color = const Color.fromRGBO(13, 100, 53, 1);
  static Color app_accent_color_extra_light =
      Color.fromRGBO(175, 224, 194, 1);

  static Color splash_screen_color = Color.fromRGBO(13, 100, 53, 1); // if not sure , use the same color as accent color
  static Color login_reg_screen_color = Color.fromRGBO(13, 100, 53, 1); // if not sure , use the same color as accent color
